...
use App\Http\Controllers\WarriorplusController;
...
Route::get('/warriorplusipnsecure', [WarriorplusController::class, 'warriorPlusIpnsecure']);
Route::post('/warriorplusipnsecure', [WarriorplusController::class, 'warriorPlusIpnsecure']);
Route::get('/sendmail', [WarriorplusController::class, 'composeEmail']);

//Route::post('/password/reset',[AuthController::class, 'saveResetAccount']);
Route::get('/send-notification', function () {
    $user = User::where('id', 9)->first(); // Assuming you have a user model and authentication system
